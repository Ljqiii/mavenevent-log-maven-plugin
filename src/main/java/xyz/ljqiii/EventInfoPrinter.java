...
import static xyz.ljqiii.SpyConstants.*;
import static xyz.ljqiii.SpyConstants.SEPARATOR;

public class EventInfoPrinter {


    private static void print(Object type, Object... args) {
        if (type.toString().equals("ARTIFACT_RESOLVED") || type.toString().equals("ARTIFACT_RESOLVING")) return;
