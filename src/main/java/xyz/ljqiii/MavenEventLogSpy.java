...
import static xyz.ljqiii.EventInfoPrinter.printMavenEventInfo;
import static xyz.ljqiii.SpyConstants.NEWLINE;

@Named("Event Spy")
@Singleton
public class MavenEventLogSpy extends AbstractEventSpy {
    @Override
